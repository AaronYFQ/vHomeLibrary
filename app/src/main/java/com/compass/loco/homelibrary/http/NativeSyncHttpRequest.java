...
public class NativeSyncHttpRequest {
    ...
    public String doSyncGetHttpRequest(String urlpath, Map<String, Object> requestParamsMap) throws IOException {
    ...
    public String doSyncPostHttpRequest(String urlpath, Map<String, Object> requestParamsMap ) throws IOException {
    ...
    private StringBuffer makeURLParmeter(int Type, Map<String, Object> requestParamsMap) {
