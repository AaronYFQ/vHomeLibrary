...
public class ThirdPartyAsyncHttpRequest {
    ...
    public void asyncHttpRequestPostHandler(String url, Map<String, Object> params, final Handler handler) {
    ...
    public void asyncHttpRequestGetHandler(String url, Map<String, Object> params, final Handler handler) {
