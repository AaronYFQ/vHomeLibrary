...
public class NativeAsyncHttpRequest {
    ...
    public  void asyncHttpRequestGetHandler(String url, Map<String, Object> map, final Handler handler) {

        doAsynRequest(GET, map, handler, url);
    }

    public  void asyncHttpRequestPostHandler(String url, Map<String, Object> map, final Handler handler) {
