package com.compass.loco.homelibrary.controller;
...
import com.compass.loco.homelibrary.adapter.ConversationListAdapter;
...
import com.compass.loco.homelibrary.adapter.SortConvList;
        ...
        if (position > 0) {
            ...
            if (null != conv) {
                ...
                if (conv.getType() == ConversationType.group) {
                    ...
                    intent.putExtra(GlobalParams.GROUP_ID, groupId);
