...
/**
 * Created by elanywa on 2016/8/3.
 */
...
public class BorrowedHistoryAdapter extends BaseAdapter {
    private ArrayList<BorrowedBookInfo> arrayBorrowedList;
    private Activity activity;

    public BorrowedHistoryAdapter(Activity activity, ArrayList<BorrowedBookInfo> list) {
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.activity_borrowed_history, null);
        } else {
            Log.v("\"convertView null at ", new Integer(position).toString());
        }

        // image = (ImageView) convertView.findViewById(R.id.array_image);
        bookname = (TextView) convertView.findViewById(R.id.array_history_book_name);
        shopname = (TextView) convertView.findViewById(R.id.array_history_shop_name);
        shopaddress = (TextView) convertView.findViewById(R.id.array_history_shop_address);
        borrowRequestTime = (TextView) convertView.findViewById(R.id.array_history_borrowed_time);
        ...
        borrowRequestTime.setText("还书时间：" + bookInfo.getFinishTime());
