...
public class MyReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
        ...
        if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
            ...
            sendRegisterIDToServer(context);
			...
			sendBroadcastToMessageFrag(context, bundle.getString(JPushInterface.EXTRA_EXTRA));
...
/*        	Intent i = new Intent(context, TestActivity.class);
			...
			i.putExtra(MainActivity.INTENT_KEY_NOTIFICATION, 0);
			i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP );
	...
	private void sendBroadcastToMessageFrag(Context context, String msgBody){
